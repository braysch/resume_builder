...
reactStory = "I am currently finishing a personal resume website using React, TypeScript, and Tailwind; all tools which I picked up about a year ago. " if ("React" in selected_skills or "Tailwind" in selected_skills or "TypeScript" in selected_skills) else ""
phpStory = "; as well as API integration using PHP Laravel. At my current job, I took on the task of writing code to have my company’s website communicate with the APIs of two different cell providers. At the beginning of the project, I had little to no knowledge of PHP, Laravel, or APIs; but was able to rapidly educate myself and fully implement the API feature. " if ("PHP" in selected_skills or "Laravel" in selected_skills or "API Integration" in selected_expertise) else ". "
...
languagesStory = " such as C++, Java, and Python" if ("C++" in selected_skills or "Java" in selected_skills or "Python" in selected_skills) else ""
mobileDevSchoolStory = " I cultivated an array of skills including HTML, JavaScript, CSS, Vue, Java, Kotlin, and Jetpack Compose." if ("HTML" in selected_skills or "JavaScript" in selected_skills or "CSS" in selected_skills or "Vue" in selected_skills or "Java" in selected_skills or "Kotlin" in selected_skills or "Jetpack Compose" in selected_skills) else ""
linuxStory = " During this time, I also became familiar with using Linux systems."
SQLStory = "While working for EFORCE Software, I became accustomed to using SQL for database navigation and management. " if ("SQL" in selected_skills) else ""

coverLetter = """I am a """ + title + """ with 8+ years of programming experience and 3+ years of mobile and web experience. I am seeking a position that strongly aligns with my passion and drive for designing innovative software, which is why I am writing to declare my candidacy for your vacant """ + position + """ role. This position would provide an opportunity for me to engage in fulfilling work while using my """ + myQualities + """ to further """ + company + """’s mission of """ + mission + """.\n
After withdrawing from my first programming class in middle school, I was able to reengage with the field via game development, which sparked my desire to study Computer Science at Utah State where I learned programming fundamentals""" + languagesStory + """.""" + pythonStory + """During the last few years of my college experience, I took a special interest in web and mobile development.""" + mobileDevSchoolStory + linuxStory + """\n
I continued to maintain and expand my skill set as a developer after graduation, undertaking personal mobile and web app projects using Android Studio. """ + kotlinStory + """After independently learning Flutter and Dart, I began to develop mobile applications, using Google Firebase for database management. """ + flutterStory + """It is important for me to write practical, neat, reusable code as well as provide an intuitive and aesthetic user experience.\n
""" + SQLStory + """At my current job, I have gained professional experience building software applications using React, Bootstrap, Tailwind, and Vue. """ + reactStory + """I also have professional experience with backend development using C, JavaScript, and TypeScript""" + phpStory + """For all my projects, personal and professional, I have a strict history of using Git for version control. While I have limited professional experience with """ + dontKnow + """, I have no doubt that I’ll be able to rapidly learn and apply these skills in the same way I’ve done with many others.\n
